...
// skip?
export function schema(csvStr, colDelim, colQuote, rowDelim, maxRows, maxBytes) {
	maxRows  ??= 10;
	maxBytes ??= 4 * 1024; // 4KB
...
export function parse(csvStr, schema, cb, withEOF = true, chunkSize = CHUNK_SIZE, chunkLimit = null, _maxCols = null) {
